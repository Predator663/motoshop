...
import { api, formatMoney, formatDate, getOfflineQueue, getCachedShift } from '../utils/api'
...
function Receipt({
  ...
  return (
    <div className="receipt" id="receipt-print">
      ...
      <div className="receipt-row"><span>{data.receipt_no}</span><span>{formatDate(data.sale_date)}</span></div>
