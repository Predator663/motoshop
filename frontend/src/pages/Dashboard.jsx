...
import { api, formatMoney, formatDateTime, formatTime, formatDateLong } from '../utils/api'
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">{T('dash_subtitle')} — {formatDateLong(new Date())}</div>
        </div>
      ...
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">
            {shiftOpen
              ? `${T('dash_shift_open_since')} ${formatTime(d.shift_opened)}`
              : T('dash_no_shift')}
          </div>
        </div>
